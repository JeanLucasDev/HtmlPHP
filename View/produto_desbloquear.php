...
<html lang="pt-br">
  <head>
    <title>Desbloquear produto</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6" style="margin: 0 auto;">
                            <label  for="id">Qual item você deseja desbloquear?(busque pelo ID)</label>
                            ...
                            <form action="tela_funcionario_principal.php">
                                <button style="width:100%;padding: 1vh;" class="btn btn-light">Desbloquear produto</button>
                            </form>
                    </div>
                </div>
            </div>
